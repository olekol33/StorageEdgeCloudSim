...
public class SampleMobileDeviceManager extends MobileDeviceManager {
	...
	static final int UPDATE_MM1_QUEUE_MODEL = BASE + 1;
	static final int REQUEST_RECEIVED_BY_CLOUD = BASE + 2;
	static final int REQUEST_RECEIVED_BY_EDGE_DEVICE = BASE + 3;
	static final int REQUEST_RECEIVED_BY_REMOTE_EDGE_DEVICE = BASE + 4;
	...
	protected static final double MM1_QUEUE_MODEL_UPDATE_INTERVAL = SimSettings.getInstance().getMm1QueueModelUpdateInterval(); //seconds
	...
	protected void processCloudletReturn(SimEvent ev) {
		...
		if(task.getAssociatedDatacenterId() == SimSettings.CLOUD_DATACENTER_ID){
			...
			//When source host is not at access point (read from distant edge)
	...
	protected void submitTaskToVm(Task task, SimSettings.VM_TYPES vmType) {
