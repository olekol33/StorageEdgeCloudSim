...
def plotAvgNetworkDelay():
    ...
    plotGenericResult(TotalTasks, networkDelay, 'Average Network Delay per Object Read (sec)', 'ALL_APPS', '')
    ...
    plotGenericResult(NetworkData, lanDelay, 'Average WLAN Delay  per Object Read (sec)', 'ALL_APPS', '')
    ...
    plotGenericResult(NetworkData, manDelay, 'Average MAN Delay  per Object Read (sec)', 'ALL_APPS', '')
    ...
    plotGenericResult(NetworkData, wanDelay, 'Average WAN Delay  per Object Read (sec)', 'ALL_APPS', '')
